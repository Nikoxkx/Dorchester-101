...
const fieldClass =
  'mt-1 w-full px-3.5 py-2.5 border border-[var(--line)] bg-[var(--paper)] text-sm font-normal rounded-[2px] outline-none focus:border-[var(--charcoal)] focus:ring-2 focus:ring-[var(--indigo)]/20';
