...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-[var(--color-accent-primary)] text-white hover:bg-[var(--color-accent-primary)]/90',
  ...
  danger: 'bg-[var(--color-accent-secondary)] text-white hover:bg-[var(--color-accent-secondary)]/90',
};
