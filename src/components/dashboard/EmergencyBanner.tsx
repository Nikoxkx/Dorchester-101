...
export function EmergencyBanner() {
  ...
  return (
    <div className={cn(
      'dor101-emergency bg-[var(--color-accent-primary)] text-white rounded-xl p-4 md:p-6',
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-heading font-semibold text-lg mb-1 text-white">{t('emergency.title')}</h3>
          <p className="text-white/90 text-sm">{t('emergency.body')}</p>
        </div>
      </div>
      <div className="flex flex-col sm:flex-row gap-3">
        <a href="tel:18006458333" className={cn('flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg', 'bg-white !text-[#14304F] font-heading font-medium', 'hover:bg-white/90 transition-colors')}>
          <Phone className="w-4 h-4 text-[#14304F]" aria-hidden="true" />
