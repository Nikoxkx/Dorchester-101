...
export const NEWS_FEEDS: NewsFeed[] = [
  ...
  },
  {
    id: 'wbur',
    name: 'WBUR News',
    url: 'https://www.wbur.org/news/rss.xml',
  ...
  },
  {
    id: 'gbh',
    name: 'GBH News',
    url: 'https://www.wgbh.org/news/rss',
    homepage: 'https://www.wgbh.org/news',
    kind: 'New England public media.',
    language: 'en',
    priority: 4,
  ...
  },
  {
    ...
    url: 'https://www.bostonglobe.com/rss/metro/?path=/metro',
    homepage: 'https://www.bostonglobe.com/metro',
    kind: 'Regional daily, metro section. Most articles sit behind a paywall.',
    language: 'en',
    priority: 5,
    enabledByDefault: false,
  },
  {
    id: 'mbta-alerts-blog',
    name: 'MBTA announcements',
    url: 'https://www.mbta.com/announcements/rss.xml',
    homepage: 'https://www.mbta.com/announcements',
    kind: 'Transit authority notices: service changes, hearings, fare policy.',
    language: 'en',
    priority: 6,
    enabledByDefault: true,
  },
  {
    id: 'hampshire-gazette-es',
    name: 'La Colmena',
    url: 'https://lacolmenanews.com/feed/',
    homepage: 'https://lacolmenanews.com',
    kind: 'Spanish-language newsroom for Greater Boston.',
    language: 'es',
    priority: 7,
    enabledByDefault: false,
  },
