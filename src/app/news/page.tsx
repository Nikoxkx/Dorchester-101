      ...
      >
        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-[var(--color-text-muted)] font-body">
              Latest news affecting Dorchester housing, food access, and community services.
            </p>
          </div>
        ...
        <Card className="bg-[var(--color-accent-green)]/5 border-[var(--color-accent-green)]/20">
          <CardContent className="py-3 flex items-center gap-3">
            ...
            <span className="text-sm font-heading">
              <strong>Live Updates</strong> — News refreshes automatically every 5 minutes
            </span>
          </CardContent>
        </Card>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {article.isVerified && (
                            <span className="text-xs text-[var(--color-accent-green)]">✓ Verified</span>
                          )}
                        </div>
        ...
        {filteredArticles.length === 0 && (
          <Card className="text-center py-12">
            ...
            <p className="font-heading font-medium mb-2">No news in this category</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-[var(--color-text-muted)] mb-4">
              News is aggregated from verified local and regional sources:
            </p>
            <div className="flex flex-wrap gap-2">
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-4">
              Last refresh: {lastUpdated || 'Never'} • Auto-updates every 5 minutes
            </p>
          </CardContent>
        </Card>
      </motion.div>
