  ...
  return (
    <MainLayout>
      <article className="max-w-2xl space-y-4 text-sm leading-relaxed">
        ...
        <p>
          This site is a public-information desk for Dorchester. It is not a city office, a housing authority, a law firm, or a newsroom of record.
        </p>
        <h2 className="font-bold text-2xl pt-2">No legal advice</h2>
        <p>
        ...
        <h2 className="font-bold text-2xl pt-2">Figures move</h2>
        <p>
        ...
        <h2 className="font-bold text-2xl pt-2">External links</h2>
        <p>
        ...
        <h2 className="font-bold text-2xl pt-2">Use</h2>
        <p>
